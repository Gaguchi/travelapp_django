                    ...
                    <div class="col-md-6 col-lg-3 mt-5 offset-lg-1">
                        <div class="ps-xl-4">
                            ...
                            <form class="quform newsletter-form"
                                action="https://monityphp.websitelayout.net/quform/newsletter-two.php" method="post"
    ...
    <!-- SCROLL TO TOP
    ================================================== -->
    <a href="index-03.php#!" class="scroll-to-top"><i class="fas fa-angle-up" aria-hidden="true"></i></a>
